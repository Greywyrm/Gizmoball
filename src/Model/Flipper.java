...
public final class Flipper implements Serializable {
     ...
     */
    public Flipper(Vect p1, Vect p2) {
        if ((p1 == null) || (p2 == null)) {
     ...
     */
    public Flipper(double x1, double y1, double x2, double y2) {
    ...
    public String toString() {
        return "Flipper(" + p1 + "-" + p2 + ")";
    }

    public boolean equals(Flipper ls) {
